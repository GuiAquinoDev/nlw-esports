...
import { SelecForm } from "./Form/select";
...
interface IPropsStatus {
  setStatusForm: (status:boolean) => void;
}

export function CreateAdModal(props: IPropsStatus) {
